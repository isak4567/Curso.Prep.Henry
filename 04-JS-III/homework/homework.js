...
function dePalabrasAFrase(palabras) {
  ...
  element = element + palabras[palabras.length -1];
  return element;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  element = element / (resultadosTest.length);
  return element;
}
